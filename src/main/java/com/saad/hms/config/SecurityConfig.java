...
// BEDS
                                ...
                                .requestMatchers(HttpMethod.PATCH, "/api/beds/**")
                                .hasAnyRole("ADMIN", "RECEPTIONIST")

                                .requestMatchers(HttpMethod.DELETE, "/api/beds/**")
                                .hasRole("ADMIN")
...
// ADMISSIONS
                                ...
                                .requestMatchers(HttpMethod.POST, "/api/admissions/**")
                                .hasAnyRole("ADMIN", "RECEPTIONIST")

                                .requestMatchers(HttpMethod.PATCH, "/api/admissions/**")
                                .hasAnyRole("ADMIN", "DOCTOR", "RECEPTIONIST")
